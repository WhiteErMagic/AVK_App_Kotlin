...
class PlanSuppliersFragment : Fragment(), SuppliersAdapter.OnClickToSupplier {
    ...
    private val viewModel by lazy{
        ViewModelProvider(this, viewModelFactory)[ListPlanSuppliersViewModel::class.java]
    }
    ...
    private fun createAdapter() {
        adapter = SuppliersAdapter(this@PlanSuppliersFragment)
